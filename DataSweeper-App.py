...
if uploaded_files:
    for file in uploaded_files:
        ...
        cleaning_options = st.expander(f"Cleaning Options for {file.name}")
        ...
        visualization_options = st.expander(f"Visualization Options for {file.name}")
...
```rgb(48, 9, 112);  /* Overall dark background for the main page */
        }
        .block-container {
            padding: 3rem 2rem; 
            border-radius: 12px;  
...
st.title("Advanced Data Sweeper by ANIQA") 
st.write("Transform your files between CSV and Excel formats with built-in data cleaning and visualization.")
